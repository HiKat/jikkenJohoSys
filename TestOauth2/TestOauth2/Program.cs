...
//		const string AUTHORIZE_URL = "https://twitter.com/oauth/authorize";
	...
	class Program
	{
		//const string CONSUMER_KEY = "92PJFWHX7tj8KSPYF6SxtM2JV";
		//const string CONSUMER_SECRET = "TDJ8Iqwskdai0zgP2gWnhORawAM5Q1JS178PfZCxiZKqLvkzLS";

		//JohoSysApiTest
		//callbackurl設定なしアカウント（設定しているとpinの画面が出ずに直接call back URLにジャンプしてしまう仕様）
		...
		static void Main (string[] args)
		{
			...
			Console.WriteLine (auth.Get ("http://api.twitter.com/1.1/statuses/home_timeline.xml?", parameters));
			...
			Console.WriteLine (auth.Post ("http://api.twitter.com/statuses/update.xml", parameters));
